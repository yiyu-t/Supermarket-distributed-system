...
public class StoreServer extends HttpServlet {
  private String msg;
  private final static int DATABASE_NUM = 3;
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse res)
    ...
    if (!isUrlValid(urlParts)) {
      ...
      // Pass it to DAO
      try {
        // if group == 0, use DataSource1
        // if group == 1, use DataSource2
        // if group == 2, use DataSource3
        PurchaseDao purchaseDao = new PurchaseDao(storeId % DATABASE_NUM);
